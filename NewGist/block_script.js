...
*/
export function TabCount(iterable_array) {
    let tab_count_array =[];
...
*/
export function TabCounter(iterable_array) {
    let tab_count_array =[];
    for (const line of iterable_array) {
        if(line === "") {
            tab_count_array.push(0);
...
*/
export function checkIfInCode(iterable_array, tab_array, start_index) {
    let if_dict =[[],[]]
 ...
 * @return {boolParam}
*/
export function check_for(line) {
    if (line.includes("#", 0)) {
...
*/
export function checkForInCode(iterable_array, tab_array, start_index) {
    let for_pair_array =[];
    for (var i = start_index; i<iterable_array.length; i++) {
 ...
 * @return {boolParam}
*/
export function check_else(line) {
    if (line.includes("#", 0)) {
...
*/
export function checkElseInCode(iterable_array, tab_array, start_index) {
    let else_pair_array =[];
    for (var i = start_index; i<iterable_array.length; i++) {
 ...
 * @return {boolParam}
*/
export function check_while(line) {
    if (line.includes("#", 0)) {
...
*/
export function checkWhileInCode(iterable_array, tab_array, start_index) {
...
*/
export function __Process_if_array(if_count_array) {
    if_processed_count =[];
    pos_array =[]
...
*/
export function Process_if_array(if_count_array) {
...
*/
export function GetFlowOfProgram(Code) {
...
*/
export function checkDefInCode(iterable_array, tab_array, start_index) {
    let def_dict =[[],[]]
    for (var i = start_index; i<iterable_array.length; i++) {
 ...
 * @return {boolParam}
*/
export function check_def(line) {
    if (line.includes("#", 0)) {
...
*/
export function get_function_name(iterable_array, def_dict) {
    let func_names =[];
 ...
 */
export function get_func_parameter(iterable_array, def_dict, func_index) {
...
*/
export function get_func_parameter_count(iterable_array, def_dict) {
    param_count =[]
    for (var i = 0; i<def_dict[0].length; i++) {
