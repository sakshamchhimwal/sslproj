/*!
Contains the logic for Hilighting Python in the file
 */
var hljs = (function ()
  {
    "use strict";
  ...
  M = (e, t, n = {}) => {
   const i = r({scope: "comment", begin: e, end: t, contains:[]}, n);
   i.contains.push(
    {
    scope: "doctag",
...
(module.exports =
 hljs); /*! `bash` grammar compiled for Highlight.js 11.6.0 */
(() =>
 {
  var e = (() =>
   {
    ...
    function o(o) {
     ...
     isTrulyOpeningTag: (e, n) => {
       ...
       (
        ...
        n.ignoreMatch()),
       (s = e.input.substring(a).match(/^\s+extends\s+/)) &&
       0 === s.index &&
       n.ignoreMatch();
      },
     },
          ...
          d =[
            ...
            contains:[
                ...
                variants:[
                    ...
                    {begin: l("m|qr", n.either(...o, {capture: !0}), /\1/)},
                    {begin: l("m|qr", /\(/, /\)/)},
                    {begin: l("m|qr", /\[/, /\]/)},
                    {
                    begin: l("m|qr", /\{/, /\}/),
  ...
  var e = (() =>
   {
    ...
    return (e) => {
     ...
     t = {className: "literal", begin: /\bon|off|true|false|yes|no\b/},
     r = {
     className: "string",
     contains:[e.BACKSLASH_ESCAPE],
     variants:[
